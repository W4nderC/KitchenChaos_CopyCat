...
public class StoveCounter : BaseCounter, IHasProgress
{
    ...
    private void State_OnValueChanged (State preState, State newState) {
    ...
    private void SetFryingRecipeSOClientRpc (int kitchenObjSOIndex) {
        KitchenObjectSO kitchenObjectSO = KitchenGameMultiplayer.Instance.GetKitchenObjectSOFromIndex(kitchenObjSOIndex);
